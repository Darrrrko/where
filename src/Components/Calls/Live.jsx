...
function Live() {
  return (
    <section className="h-screen w-[70%] pt-5 overflow-scroll shadow-[0px 4px 4px 0px] shadow-[rgba(0, 0, 0, 0.25)] pr-5 flex flex-col items-center">
      ...
      <div
        className="w-full grid grid-cols-3 jube
       items-center mt-10"
      >
